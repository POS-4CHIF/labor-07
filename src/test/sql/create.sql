...
CREATE TABLE kurstyp (
  kurstyp_id char(1) NOT NULL,
  kurstyp_bezeichnung  varchar(100),
  CONSTRAINT kurstyp_kunde_pkey PRIMARY KEY (kurstyp_id)
);
...
INSERT INTO kurstyp VALUES ('P', 'Programmierung');
INSERT INTO kurstyp VALUES ('S', 'Skriptsprachen');
INSERT INTO kurstyp VALUES ('W', 'Webtechnologien');
...
CREATE TABLE kurs (
  ...
  CONSTRAINT        kurs_fk_kurstyp FOREIGN KEY (kurs_typ)
                    REFERENCES kurstyp(kurstyp_id)
);
